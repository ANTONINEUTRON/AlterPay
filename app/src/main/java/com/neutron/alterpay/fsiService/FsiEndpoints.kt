...
interface FsiEndpoints {
    ...
    fun sendSmsThroughAfricastalking(@Body africasTalkingPack: AfricasTalkingPack): Call<ResponseBody>

    @Headers("Content-Type: application/json",
        "sandbox-key: 2JuUclGZ2Pd0dUfrgwZGg5PD1YHdByrU1649586645",
        "Authorization: dskjdks")
    @POST("flutterwave/v3/charges?type=card")
    fun chargeCard(@Body flutterwavePack: FlutterwavePack): Call<ResponseBody>//Due to simulation constraint no point handling response
}